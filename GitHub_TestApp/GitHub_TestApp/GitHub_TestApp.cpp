...
// GitHub_TestApp.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CGitHub_TestAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CGitHub_TestAppApp

CGitHub_TestAppApp::CGitHub_TestAppApp()
{
...
// Единственный объект CGitHub_TestAppApp

CGitHub_TestAppApp theApp;


// инициализация CGitHub_TestAppApp

BOOL CGitHub_TestAppApp::InitInstance()
{
